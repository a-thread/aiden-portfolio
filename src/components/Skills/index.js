            ...
            <Box className="skillsContainer">
                ...
                <div className="skillsSection">
                    <div className="skillsList border">
                        <span className="blue"><i class="fas fa-laptop-code"></i></span>
                        <h2>Front End</h2>
                        <p>HTML5, CSS, Javascript, jQuery TypeScript, Bootstrap, Material, React</p>
                    </div>
                    <div className="skillsList border">
                        <span className="blue"><i class="fas fa-terminal"></i></span>
                        <h2>Back End</h2>
                ...
                <div className="skillsSection">
                    <div className="skillsList">
                        <span className="blue"><i class="fas fa-code-branch"></i></span>
                        <h2>Tools</h2>
                        <p>Github, VSCode, Git, Jira, Hubspot, Slack</p>
                    </div>
                    <div className="skillsList">
                        <span className="blue"><i class="fas fa-users-cog"></i></span>
                        <h2>Soft Skills</h2>
